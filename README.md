...
- Парсинг число сторипоинтов любым регулярным выражением с именованными направлениями
- Отображение числа сторипоинтов по направлениям у каждого разработчика
- Отображение сумму сторипоинтов у разработчика
- Цветовая индикация превышения числа сторипоинтов
